...
#e2$ChrPosRefAlt<- paste0(e1$CHR, ":", e1$POS, "_", e1$Tested_Allele, "_", e1$Other_Allele)
#e2$ChrPosAltRef<- paste0(e1$CHR, ":", e1$POS, "_", e1$Other_Allele, "_", e1$Tested_Allele)
...
e1_comm<- e1[e1$SNP_ID %in% e2$SNP,] 
...
write.table(e1_comm, "TC.filtered.txt", sep="\t", quote= FALSE, row.names= FALSE, col.names= TRUE)
