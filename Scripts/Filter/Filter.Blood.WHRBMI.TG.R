...
out <- fread("/project/voight_datasets/GWAS/61_dbGAP_MVP/79613/MVP.Lipids/MVP.EUR.TG.gwas.dbGAP.txt.gz", header=T)
out$Phenotype<- "TG"
...
write.table(out_comm, "TG.filtered.txt", sep="\t", quote= FALSE, row.names= FALSE, col.names= TRUE)
