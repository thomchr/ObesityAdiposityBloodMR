...
##open exposure
e1<- fread("/project/voight_datasets/GWAS/04_giant/whradjbmi.giant-ukbb.meta-analysis.combined.23May2018.txt.gz", header=T)
e1$Phenotype<- "WHRadjBMI"
e1$SNP<- gsub("[A-Z]|:", "", e1$SNP) #bcWHRadjWHRandWHRhaversID:Allele:Allele
...
lapply(files, function(x) {
  ...
  ### MR Steiger test of directionality
  ## Testing e1->t (for WHRadjBMI on blood, this is WHRadjBMI->blood)
  cat("\n\nTesting e1->t\n")
