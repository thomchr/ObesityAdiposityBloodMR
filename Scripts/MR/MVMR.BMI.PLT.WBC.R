...
setwd("/project/voight_ML/thomc/thomc_results/MendelianRandomization/MR.Laptop.Backup.200502/MR.Smk.Blood.ASCVD/2020VuckovicBloodData/MVMR.BMI.PLT.WBC/")
...
write.table(combined.e1_e2, paste0("BMI.PLT.WBC.MVMR.IV.txt"), sep="\t", row.names=F, col.names=TRUE, quote=FALSE)
...
cat(paste0("BMI.PLT.WBC.MVMRIVW"))
