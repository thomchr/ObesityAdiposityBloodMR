...
setwd("/project/voight_ML/thomc/thomc_results/MendelianRandomization/MR.Laptop.Backup.200502/MR.Smk.Blood.ASCVD/2020VuckovicBloodData/MVMR.BMI.WBC.RBC/")
...
write.table(combined.e1_e2, paste0("BMI.WBC.RBC.MVMR.IV.txt"), sep="\t", row.names=F, col.names=TRUE, quote=FALSE)
...
cat(paste0("BMI.WBC.RBC.MVMRIVW"))
