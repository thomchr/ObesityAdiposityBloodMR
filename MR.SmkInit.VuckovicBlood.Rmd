---
title: "MR.SmkInit.VuckovicBlood"
author: "Chris Thom"
date: "1/28/21"
...
setwd("/Users/thomc/Desktop/Smk.BMI.Blood.MR/MR.SmkInit.HGB/")
...
if( file.exists("SmkInit.filtered.txt") & file.exists("HGB.filtered.txt")) { 
  ...
  e1$ChrPosRefAlt <- paste0(e1$CHR, ":", e1$POS, "_", e1$ALT, "_", e1$REF)
  e1$ChrPosAltRef <- paste0(e1$CHR, ":", e1$POS, "_", e1$REF, "_", e1$ALT)
...
if( file.exists("SmkInit.Clumped") & file.exists("HGB.Clumped")) { 
