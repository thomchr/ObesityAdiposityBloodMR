---
title: "MR.WHRadjBMI.VuckovicBlood"
author: "Chris Thom"
date: "1/30/21"
output:
...
setwd("/Users/thomc/Desktop/Smk.BMI.Blood.MR/MR.WHRadjBMI.HGB/")
...
if( file.exists("WHRadjBMI.filtered.txt") & file.exists("HGB.filtered.txt")) { 
  ...
  e1_comm$SNP <- gsub("[A-Z]|:", "", e1_comm$SNP) #bc WHRadjBMI has rsID:Allele:Allele
  ...
  out_comm$SNP <- gsub("[A-Z]|:", "", out_comm$SNP)
...
if( file.exists("WHRadjBMI.Clumped") & file.exists("HGB.Clumped")) { 
