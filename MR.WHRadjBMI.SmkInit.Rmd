...
setwd("/Users/thomc/Desktop/Smk.BMI.Blood.MR/MR.WHRadjBMI.SmkInit/")
...
if( file.exists("SmkInit.filtered.txt") & file.exists("WHRadjBMI.filtered.txt")) { 
  ...
  e1$SNP <- gsub("[A-Z]|:", "", out$SNP) #bc WHRadjBMI has rsID:Allele:Allele
...
if( file.exists("SmkInit.Clumped") & file.exists("WHRadjBMI.Clumped")) { 
