---
title: "MVMR.BMI.LfSmk.VuckovicBlood"
author: "Chris Thom"
date: "1/29/21"
...
setwd("/Users/thomc/Desktop/Smk.BMI.Blood.MR/MVMR.BMI.LfSmk.HGB/")
...
if( file.exists("LfSmk.filtered.txt") & file.exists("BMI.filtered.txt") & file.exists("HGB.filtered.txt")) { 
...
if( file.exists("LfSmk.Clumped") & file.exists("BMI.Clumped") & file.exists("HGB.Clumped")) { 
...
e1_clump <- e1_comm[e1_comm$SNP %in% e2_clump$SNP]
...
out_clump <- out_comm %>% filter(SNP %in% e2_clump$SNP)
